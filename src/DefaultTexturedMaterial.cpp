...
/*
std::vector<D3D12_ROOT_PARAMETER> DefaultTexturedMaterial::CreateRootParameters()
{
...
D3D12_ROOT_SIGNATURE_FLAGS DefaultTexturedMaterial::CreateRootSignatureFlags()
{
