...
class ShadowMapMainMaterial : public Material
{
public:
    ShadowMapMainMaterial() = default;
    ShadowMapMainMaterial(const std::string vertexShaderFileName, const std::string pixelShaderFileName) {
