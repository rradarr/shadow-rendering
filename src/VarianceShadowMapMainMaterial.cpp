...
std::vector<D3D12_ROOT_PARAMETER> VarianceShadowMapMainMaterial::CreateRootParameters()
{
...
void VarianceShadowMapMainMaterial::CustomizePipelineStateObjectDescription(D3D12_GRAPHICS_PIPELINE_STATE_DESC &psoDesc)
{
}

std::vector<D3D12_STATIC_SAMPLER_DESC> VarianceShadowMapMainMaterial::CreateSamplers()
{
    ...
    // Create a simple static sampler description for the depth shadow map.
    ...
    // Create additional shadow map sampler with filtering.
    samplerDepthShadowMap.Filter = D3D12_FILTER_MIN_MAG_LINEAR_MIP_POINT;
...
D3D12_ROOT_SIGNATURE_FLAGS VarianceShadowMapMainMaterial::CreateRootSignatureFlags()
{
