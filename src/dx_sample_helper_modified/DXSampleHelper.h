...
// Note: This file has been modified by me due to compilation issues with:
// error C2664: 'DWORD GetModuleFileNameA(HMODULE,LPSTR,DWORD)': cannot convert argument 2 from 'WCHAR *' to 'LPSTR'
...
inline void GetAssetsPath(_Out_writes_(pathSize) WCHAR* path, UINT pathSize)
{
    ...
    LPWSTR widePath = path;

    DWORD size = GetModuleFileNameW(nullptr, widePath, pathSize);
