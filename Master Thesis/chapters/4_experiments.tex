...
\section{testing of multiple figures}

\begin{figure}
\includegraphics[width=0.5\textwidth]{./graf/test_image.jpg}
\caption{Caption of a figure is always below the figure akakak.}
\label{fig:duped_image}
\end{figure}

some citation of the above \ref{fig:duped_image}

\begin{figure}
\includegraphics[width=0.5\textwidth]{./graf/test_image.jpg}
\caption{Caption of a figure is always below the figure akakak.}
\label{fig:duped_image2}
\end{figure}

some citation of the above \ref{fig:duped_image2}
